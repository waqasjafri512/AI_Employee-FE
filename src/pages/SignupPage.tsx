...
import { UserPlus, Mail, Lock, Loader2, Bot, Building2, User } from 'lucide-react';
...
const SignupPage = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 transition-colors duration-500">
            <div className="fixed top-0 right-0 w-96 h-96 bg-brand-500/10 rounded-full blur-[100px] translate-x-1/2 -translate-y-1/2" />
            ...
            <div className="w-full max-w-xl relative">
                <div className="glass-card p-10 md:p-14 animate-in zoom-in-95 duration-500">
                    <div className="flex flex-col items-center mb-10 text-center">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 font-medium">Register your company to automate your customer service.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest px-1">Admin Name</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest px-1">Create Password</label>
                            <div className="relative group">
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-sm font-medium text-slate-500">
                            ...
                            <Link to="/login" className="text-brand-600 dark:text-brand-400 font-black hover:underline">Log In</Link>
                        </p>
                    </div>
                </div>
            </div>
